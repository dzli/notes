---
title: "luckyPipewrench/pipelock: Open-source AI agent firewall for MCP security: agent egress control, DLP, SSRF, and prompt injection defense."
source: "https://github.com/luckyPipewrench/pipelock"
author:
published:
created: 2026-05-09
description: "Open-source AI agent firewall for MCP security: agent egress control, DLP, SSRF, and prompt injection defense. - luckyPipewrench/pipelock"
tags:
  - "clippings"
---
[![Pipelock](https://github.com/luckyPipewrench/pipelock/raw/main/assets/pipelock-logo.svg)](https://github.com/luckyPipewrench/pipelock/blob/main/assets/pipelock-logo.svg)
...
[Quick Start](#quick-start) · [What It Does](#what-it-does) · [Docs](https://github.com/luckyPipewrench/pipelock/blob/main/docs) · [Blog](https://pipelab.org/blog/) · [Ask Dosu](https://app.dosu.dev/bcccd1cf-be85-4c0e-ae05-edeb0ff50b59/ask)
...
[![Pipelock demo](https://github.com/luckyPipewrench/pipelock/raw/main/assets/demo.gif)](https://github.com/luckyPipewrench/pipelock/blob/main/assets/demo.gif)
...
See [docs/bypass-resistance.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/bypass-resistance.md) for the full evasion test matrix.
...
`text/event-stream` responses (OpenAI chat completions, Anthropic messages, Kilo Gateway, MCP HTTP/SSE) stream through with per-event DLP and injection scanning so token-by-token LLM chat UX is preserved while body scanning stays on. Clean events flush immediately; a detection terminates the stream fail-closed. Compressed SSE streams are rejected since compressed bytes evade regex matching. See [SSE streaming guide](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/sse-streaming.md).
...
See [docs/scan-api.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/scan-api.md) for the full API reference.
...
See [docs/guides/siem-integration.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/siem-integration.md) for log schema, forwarding patterns, and example SIEM queries.
...
[![Pipelock Security Summary showing grade C (79/100) with compliance coverage, MCP protection, and detection scoring](https://github.com/luckyPipewrench/pipelock/raw/main/docs/assets/assess-summary.png)](https://github.com/luckyPipewrench/pipelock/blob/main/docs/assets/assess-summary.png)
...
| --- | --- |
| **Audit Reports** | `pipelock report --input events.jsonl` generates HTML/JSON reports with risk rating, timeline, and evidence appendix. Ed25519 signing with `--sign`. ([Sample report](https://github.com/luckyPipewrench/pipelock/blob/main/examples/sample-report.html)) |
...
| **Fleet Monitoring** | Prometheus metrics + ready-to-import [Grafana dashboard](https://github.com/luckyPipewrench/pipelock/blob/main/configs/grafana-dashboard.json) |
...
[![Pipelock Agent Egress Report showing risk rating, timeline, findings by category, and evidence appendix](https://github.com/luckyPipewrench/pipelock/raw/main/examples/sample-report.png)](https://github.com/luckyPipewrench/pipelock/blob/main/examples/sample-report.png)

[![Pipelock Fleet Monitor: Grafana dashboard showing traffic, security events, and WebSocket metrics](https://github.com/luckyPipewrench/pipelock/raw/main/docs/assets/fleet-dashboard.jpg)](https://github.com/luckyPipewrench/pipelock/blob/main/docs/assets/fleet-dashboard.jpg)
...
For agents running uncensored or abliterated models (e.g. OBLITERATUS), the [`hostile-model` preset](https://github.com/luckyPipewrench/pipelock/blob/main/configs/hostile-model.yaml) layers additional defenses on top of strict mode: aggressive entropy thresholds (3.0), blanket network tool blocking, session binding, cross-request exfiltration detection, and a pre-configured kill switch. `pipelock audit` recommends this preset when it detects known guardrail-removal toolchains (currently dependency-based detection).
...
Config changes are picked up automatically via file watcher or SIGHUP. Full reference: **[docs/configuration.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/configuration.md)**

For false positive tuning: **[docs/false-positive-tuning.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/false-positive-tuning.md)**

## Integration Guides

- **[Claude Code](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/claude-code.md):** MCP proxy setup, `.claude.json` configuration
- **[OpenAI Codex](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/codex.md):** MCP proxy wrapping, forward proxy, sandbox integration
- **[OpenAI Agents SDK](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/openai-agents.md):** `MCPServerStdio`, multi-agent handoffs
- **[Google ADK](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/google-adk.md):** `McpToolset`, `StdioConnectionParams`
- **[AutoGen](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/autogen.md):** `StdioServerParams`, `mcp_server_tools()`
- **[CrewAI](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/crewai.md):** `MCPServerStdio` wrapping, `MCPServerAdapter`
- **[LangGraph](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/langgraph.md):** `MultiServerMCPClient`, `StateGraph`
- **[JetBrains/Junie](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/jetbrains.md):** MCP proxy wrapping for IntelliJ, PyCharm, GoLand ([walkthrough](https://pipelab.org/learn/jetbrains-integration/))
- **Cursor:** use `configs/cursor.yaml` with the same MCP proxy pattern as [Claude Code](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/claude-code.md) ([walkthrough](https://pipelab.org/learn/cursor-integration/))
- **[OpenClaw](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/openclaw.md):** Gateway sidecar, init container, config wrapping
...
Production recipes (Docker Compose with network isolation, Kubernetes sidecar + NetworkPolicy, iptables/nftables, macOS PF): **[docs/guides/deployment-recipes.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/deployment-recipes.md)**
...
Downloads a pre-built binary, runs `pipelock audit`, scans the PR diff for leaked secrets, and uploads the audit report as a workflow artifact. See [`examples/ci-workflow.yaml`](https://github.com/luckyPipewrench/pipelock/blob/main/examples/ci-workflow.yaml) for a complete workflow.
...
See [docs/rules.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/rules.md) for details.
...
Reference matrix: [docs/comparison.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/comparison.md)
...
Details, config examples, and gap analysis: [docs/owasp-mapping.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/owasp-mapping.md)

## Docs

| Document | What's In It |
| --- | --- |
| [Configuration Reference](https://github.com/luckyPipewrench/pipelock/blob/main/docs/configuration.md) | All config fields, defaults, hot-reload behavior, presets |
| [Request Redaction](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/redaction.md) | JSON request rewriting across HTTP, WebSocket, and MCP transports |
| [False Positive Tuning](https://github.com/luckyPipewrench/pipelock/blob/main/docs/false-positive-tuning.md) | Identifying, suppressing, and tuning scanner findings |
| [Scan API](https://github.com/luckyPipewrench/pipelock/blob/main/docs/scan-api.md) | Evaluation endpoint for programmatic scanning |
| [Deployment Recipes](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/deployment-recipes.md) | Docker Compose, K8s sidecar, iptables, macOS PF |
| [Bypass Resistance](https://github.com/luckyPipewrench/pipelock/blob/main/docs/bypass-resistance.md) | Known evasion techniques, mitigations, limitations |
| [Known Attacks Blocked](https://github.com/luckyPipewrench/pipelock/blob/main/docs/attacks-blocked.md) | Real attacks with repro snippets |
| [SIEM Integration](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/siem-integration.md) | Log schema, forwarding patterns, SIEM queries |
| [Metrics Reference](https://github.com/luckyPipewrench/pipelock/blob/main/docs/metrics.md) | Prometheus metric families, labels, JSON stats, and alert rules |
| [Community Rules](https://github.com/luckyPipewrench/pipelock/blob/main/docs/rules.md) | Install, configure, and create signed rule bundles |
| [Security Assurance](https://github.com/luckyPipewrench/pipelock/blob/main/docs/security-assurance.md) | Security model, trust boundaries, supply chain |
| [Finding Suppression](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/suppression.md) | Rule names, path matching, inline comments |
| [Transport Modes](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/transport-modes.md) | All proxy modes and their scanning capabilities |
| [OWASP MCP Top 10](https://github.com/luckyPipewrench/pipelock/blob/main/docs/compliance/owasp-mcp-top10.md) | OWASP MCP Top 10 coverage |
| [OWASP Agentic Top 15](https://github.com/luckyPipewrench/pipelock/blob/main/docs/owasp-agentic-top15-mapping.md) | OWASP Agentic AI Top 15 coverage |
| [EU AI Act](https://github.com/luckyPipewrench/pipelock/blob/main/docs/compliance/eu-ai-act-mapping.md) | EU AI Act compliance mapping |
| [NIST 800-53](https://github.com/luckyPipewrench/pipelock/blob/main/docs/compliance/nist-800-53.md) | NIST SP 800-53 Rev. 5 controls mapping |
| [Policy Spec v0.1](https://github.com/luckyPipewrench/pipelock/blob/main/docs/policy-spec-v0.1.md) | Portable agent firewall policy format |
| [Mediation Envelope](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/mediation-envelope.md) | Sideband metadata headers, config, interaction with receipts |
| [Media Policy](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/media-policy.md) | Stego stripping, SVG hardening, allowed types, size limits |
| [Receipt Verification](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/receipt-verification.md) | verify-receipt CLI, conformance suite, chain integrity |
| [Receipt Transport Coverage](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/receipt-transports.md) | Receipt emission matrix across fetch, forward, CONNECT/TLS, WebSocket, MCP, and A2A paths |
| [Learn-and-Lock](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/learn-and-lock.md) | Per-agent behavioral contracts: observe, compile, shadow, ratify, promote (v2.4) |
| [Federation](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/federation.md) | Inbound mediation envelope verification, SPIFFE actor format, RFC 9421 well-known directory (v2.4) |
| [Block-Reason Header](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/block-reason-header.md) | `X-Pipelock-Block-Reason` schema, reason vocabulary, retry hints (v2.4) |
| [Health Endpoint](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/health.md) | `/health` 503 wedge detection, subsystem heartbeats, operator dashboard config (v2.4) |
| [Posture Capsule](https://github.com/luckyPipewrench/pipelock/blob/main/docs/guides/posture-capsule.md) | Signed posture snapshots, `posture verify` CLI, CI gate, scoring model |
| [`pipelock init sidecar`](https://github.com/luckyPipewrench/pipelock/blob/main/docs/cli/init-sidecar.md) | Generate enforced Kubernetes companion-proxy manifests (strategic-merge, Kustomize, Helm values) |
| [`pipelock session`](https://github.com/luckyPipewrench/pipelock/blob/main/docs/cli/session.md) | Operator CLI for airlock inspection and recovery (list, inspect, explain, release, terminate, recover) |
| [Badges](https://github.com/luckyPipewrench/pipelock/blob/main/docs/badges.md) | Drop-in Markdown for the `scanned by pipelock` badge on downstream projects |
...
- See [docs/comparison.md](https://github.com/luckyPipewrench/pipelock/blob/main/docs/comparison.md) for how Pipelock relates to other tools in this space
- Security review contributions from Dylan Corrales

Contributions welcome. See [CONTRIBUTING.md](https://github.com/luckyPipewrench/pipelock/blob/main/CONTRIBUTING.md) for guidelines.
...
See [LICENSE](https://github.com/luckyPipewrench/pipelock/blob/main/LICENSE) for the Apache 2.0 text and [enterprise/LICENSE](https://github.com/luckyPipewrench/pipelock/blob/main/enterprise/LICENSE) for the ELv2 text.